...
const HotelCard = ({ room, index }: Props) => {
  return (
    <Link
      to={`/rooms/${room._id}`}
    ...
    >
      ...
      <div className="p-4 pt-5">
        ...
        <div className="flex items-center justify-between mt-4">
          ...
          <button className="px-4 py-2 text-sm font-medium border border-gray-300 rounded hover:bg-gray-800 hover:text-white transition-all cursor-pointer">
            Book Now
          </button>
        </div>
      </div>
